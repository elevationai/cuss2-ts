...
// Prefilled AEA commands for printers (from cuss2-test-application)
  ...
  populateActionColumns(leftColumn, rightColumn, id, component, capabilities) {
    ...
    if (capabilities.includes('setup')) {
      ...
      if (isPrinter && dropdown) {
        ...
        let commandSet = null;
        if (deviceType.includes('boardingpass')) {
          commandSet = aeaCommands.boardingPassPrinter;
        } else if (deviceType.includes('bagtag')) {
